...
public class Cerulean #if FABRIC implements ModInitializer, ClientModInitializer #endif
{
    ...
    public Cerulean(#if NEO IEventBus modEventBus, ModContainer modContainer #endif) {
        ...
        #if NEO
        NeoForge.EVENT_BUS.addListener((AddServerReloadListenersEvent event) -> event.addListener(Identifier.fromNamespaceAndPath(Cerulean.ID, "reload_listener"), new ReloadListenerHandlerBase()));
        #endif
    }
